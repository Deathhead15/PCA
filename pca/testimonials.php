...
<body>
  <div id="main">
	...
	<div id="site_content">
      ...
      <div id="text_content">   
        <h2>Events</h2>
        <h3>January 16, 2016</h3>
        <h4>Pasay Adventist Church</h4>
	    <p>&ldquo;Sabbath School Hour of Worship at Pasay Adventist Church would be handled by Pasay City Academy Alumni</p>
        <h4>Manila Adventist Medical Center and Colleges</h4>
        <p>&ldquo;Alumni Dinner at Manila Adventis Medical Center and Colleges which would start at </p>
