...
<body>
  <div id="main">
	...
	<div id="site_content">
      ...
      <div id="text_content">   
        <h3 id="title">Events</h2>
        <h3 id="title">January 16, 2016</h3>
        <h4 id="happen">Pasay Adventist Church</h4>
	    <p>&ldquo;Sabbath School Hour of Worship at Pasay Adventist Church would be handled by Pasay City Academy Alumni</p>
        <h4 id="happen">Manila Adventist Medical Center and Colleges</h4>
        <p>&ldquo;Alumni Dinner at Manila Adventist Medical Center and Colleges which would start at </p>
